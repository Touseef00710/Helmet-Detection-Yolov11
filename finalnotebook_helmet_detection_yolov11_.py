...
!pip install streamlit opencv-python-headless pyngrok pillow

"""**Upload / Mount your YOLO files**"""

from google.colab import files
uploaded = files.upload()  # Upload cfg, weights, and names files
...
"""**Run Streamlit + Ngrok from the notebook**
